...
use restaurantTunisie\PidevSiteBundle\Entity\Restaurant;
use restaurantTunisie\PidevSiteBundle\Form\RestaurantType;
...
class RestaurantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PidevSiteBundle:Restaurant')->findAll();

        return $this->render('PidevSiteBundle:Restaurant:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PidevSiteBundle:Restaurant:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PidevSiteBundle:Restaurant')->find($id);
        ...
        return $this->render('PidevSiteBundle:Restaurant:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PidevSiteBundle:Restaurant:edit.html.twig', array(
            'entity'      => $entity,
