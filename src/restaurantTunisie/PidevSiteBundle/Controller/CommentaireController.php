...
use restaurantTunisie\PidevSiteBundle\Entity\Commentaire;
use restaurantTunisie\PidevSiteBundle\Form\CommentaireType;
...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PidevSiteBundle:Commentaire')->findAll();

        return $this->render('PidevSiteBundle:Commentaire:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PidevSiteBundle:Commentaire:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PidevSiteBundle:Commentaire')->find($id);
        ...
        return $this->render('PidevSiteBundle:Commentaire:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PidevSiteBundle:Commentaire:edit.html.twig', array(
            'entity'      => $entity,
